        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                <form action="admin/sanpham/sua/{{$sanpham->id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Đơn giá</label>
                        <input class="form-control" name="unitprice" value="{{$sanpham->unit_price}}" placeholder="Vui lòn nhập đơn giá" />
                    </div>
                    <div class="form-group">
                        <label>Giá khuyến mãi</label>
                        <input class="form-control" name="promotionprice" value="{{$sanpham->promotion_price}}" placeholder="Vui lòn nhập giá khuyến mãi" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Đơn vị</label>
                        <input class="form-control" name="unit" value="{{$sanpham->unit}}" placeholder="Vui lòn nhập đơn vị" />
                    </div>
                    <div class="form-group">
                        <label>Nổi bật</label>
